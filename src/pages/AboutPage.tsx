...
export default function AboutPage() {
  return (
    <div className="space-y-4 pb-16">
      <div className="mb-3">
        <h1 className="text-lg font-semibold text-slate-900 dark:text-slate-100">About &amp; Privacy</h1>
      ...
      <Card className="p-6">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm text-slate-600 dark:text-slate-300">
          ...
          <li>
            When you ask for output, your content passes through our server just long enough to
            forward it to an AI provider and send the result back to you. Nothing is saved or
